...
// purpose: contracts list page rendered inside the app shell sidebar
...
export default function contracts_page() {
    ...
    async function sync_and_refresh() {
        ...
        try {
            // dev/local: pull latest Documenso status into DB, then reload list
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            // fetch org for the "new contract" button
        ...
        // gentle polling while on list (useful locally if webhooks can’t reach)
